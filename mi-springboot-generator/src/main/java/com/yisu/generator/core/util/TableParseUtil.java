package com.yisu.generator.core.util;



import com.yisu.generator.core.exception.CodeGenerateException;
import com.yisu.generator.core.model.ClassInfo;
import com.yisu.generator.core.model.FieldInfo;
...
/**
 * @author xuyisu 2018-05-02 21:10:45
 */
public class TableParseUtil {
    ...
    public static ClassInfo processTableIntoClassInfo(String tableSql) throws IOException {
        ...
        if(tableSql.contains("comment"))
            throw new IOException("comment 应该修改为  COMMENT");
        // table Name
        ...
        if (fieldLineList.length > 0) {
            for (String columnLine :fieldLineList) {
                ...
                if (columnLine.startsWith("`")){
                    ...
                    if(org.apache.commons.lang3.StringUtils.isBlank(fieldComment))
                        System.out.println(fieldInfo);
                    fieldInfo.setFieldComment(org.apache.commons.lang3.StringUtils.isBlank(fieldComment)?"请鞋上代码注释":fieldComment);

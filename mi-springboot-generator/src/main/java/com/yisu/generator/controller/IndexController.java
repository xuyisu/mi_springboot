package com.yisu.generator.controller;

import com.yisu.generator.core.CodeGeneratorTool;
import com.yisu.generator.core.model.ClassInfo;
import com.yisu.generator.model.ReturnT;
import com.yisu.generator.util.FreemarkerTool;
 ...
 * sso server (for web)
 *
 * @author xuyisu 2017-08-01 21:39:47
 */
@Controller
    ...
    public ReturnT<Map<String, String>> codeGenerate(String tableSql) {
        ...
        try {
           ...
           result.put("controller_code", freemarkerTool.processString("xxl-code-generator/controller.ftl", params));
            ...
            return new ReturnT<Map<String, String>>(ReturnT.FAIL_CODE,StringUtils.isNotBlank(e.getMessage())?e.getMessage():"表结构解析失败");
        }
